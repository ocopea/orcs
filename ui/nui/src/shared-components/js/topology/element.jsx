...
export default class Element extends React.Component {
  ...
  render(){
    ...
    const { id, name, componentType,
            ...
            uiStore, imgSrc, iconSrc, isActive } = this.props;

    const isLoading = HandleState.isLoading(state)
        ...
        <div
          ...
          onClick =   {this.onClick.bind(this)}>
            ...
            <div title={name} className={'Topology__element__title'}>{name}</div>
            {
              ...
              :
              uiStore.showState ? HandleState.isError(state) ?
            ...
            {/* Alerts */}
            {
              ...
              this.props.alerts.length ?
               <div className="Topology__element__alert">
                 <span className="icon-topology-alert" title={this.props.alerts[0]}></span>
               </div>
              : null
            }
  ...
  handlePlansMenu(e) {
    ...
    position.top += this.props.componentType === componentTypes.dependency ?
                    this.props.height :
                    this.props.height -
                      UiController.marginBetweenElements - cssMargin;
